...
$hook_options = NULL;
$dest_fields = array();
$dest_fields[0] = 'field_nefo_product_field_type';
$dest_fields[1] = 'field_nefo_product_document';
$dest_fields[2] = 'field_nefo_product_link';
$dest_fields[3] = 'field_nefo_description';
$dest_fields[4] = 'field_nefo_product_icon';
$dest_fields[5] = 'field_nefo_taxonomy_tags';
...
$source_fields[1] = 'field_nefo_factsheet';
$source_fields[2] = 'field_nefo_factsheet_link';
$nodes = node_load_multiple(NULL, array('type' => $source_node_type));
foreach ($nodes as $nid => $node) {
